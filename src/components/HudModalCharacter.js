    ...
    return (
      <div className="dd__frame dd__modal__character">
        ...
        <div className="dd__modal__character__bio">
          Młoda, inteligentna, piękna. Wychowana tylko do tego, żeby w
          trafić do pałacu jako luksusowa niewolnica, do czego
          faktycznie ma wszystkie predyspozycje. Większość życia
          spędziła w wygodzie, dlatego nie ma dobrej kondycji.

          Nigdy nie akceptowała do końca swego losu, mimo, że w gruncie
          rzeczy oferował komfort (i względną beztroskę) i zawsze w
          miarę możliwości zakradała się do biblioteki, żeby dowiedzieć
          się czegoś o świecie przynajmniej w ten sposób. Zawsze
          liczyła na to, że może kiedyś będzie miała okazję wyrwać się 
          i sama o siebie zadbać, a wtedy każda wiedza może się
          przydać.
        ...
        <dl className="dd__modal__character__soul">
          ...
          <dd>20/0-100</dd>
          <dt>
            Brak poczucia rzeczywistości, niezaangażowanie i dystans
          </dt>
          <dd>20/0-100</dd>
          <dt>
            Bojaźliwość
          ...
          <dd>20/0-100</dd>
          <dt>
            Pycha / zawyżone poczucie własnej wartości
          </dt>
          <dd>20/0-100</dd>
          <dt>
