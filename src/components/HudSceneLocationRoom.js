...
export default class HudSceneLocationRoom extends React.Component<
  Props,
  State
> {
  render() {
        ...
        <article>
          <div className="dd-tp__formatted-text">
            ...
            <p>
              ...
              mnicha-zielarza. Nie ma tu nic, ponad to co niezbędne, ale nawet
              ta ascetyczna prostota w porównaniu z obszernym pustkowiem na
              zewnątrz jest dla ciebie jak bogaty pałacyk.
            </p>
          </div>
