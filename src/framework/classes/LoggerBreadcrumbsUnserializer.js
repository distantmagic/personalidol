...
export default class LoggerBreadcrumbsUnserializer implements LoggerBreadcrumbsUnserializerInterface {
  fromJson(serialized: string): LoggerBreadcrumbsInterface {
    return this.fromObject(JSON.parse(serialized));
  }

  fromObject(parsed: LoggerBreadcrumbsSerializedObject): LoggerBreadcrumbsInterface {
