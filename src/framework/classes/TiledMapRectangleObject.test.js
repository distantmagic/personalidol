...
it("is comparable with other ellipse objects", function() {
  ...
  const tiledMapRectangleObject1 = new TiledMapRectangleObject(
  ...
  const tiledMapRectangleObject2 = new TiledMapRectangleObject(
    tiledMapBlockObject2
  );

  expect(tiledMapRectangleObject1.isEqual(tiledMapRectangleObject2)).toBe(
    false
  );
});
...
it("is serializable as JSON", function() {
  ...
  const tiledMapRectangleObject = new TiledMapRectangleObject(
    tiledMapBlockObject
  );
