...
it("is equatable", function() {
  ...
  const tiledTileset1 = new TiledTileset(loggerBreadcrumbs, 1, 1, tiledTilesetTileSize);
  ...
  const tiledTileset2 = new TiledTileset(loggerBreadcrumbs, 1, 1, tiledTilesetTileSize);
...
it("is JSON serializable", function() {
  ...
  const tiledTileset = new TiledTileset(loggerBreadcrumbs, 1, 1, new ElementSize<"px">(10, 10));
