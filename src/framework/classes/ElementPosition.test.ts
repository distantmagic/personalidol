...
test("calculates distance to other element position", function() {
  const elementPosition1 = new ElementPosition("px", 10, 10, 5);
  const elementPosition2 = new ElementPosition("px", 10, 20, 5);
...
test("is comparable with other element positions", function() {
  const elementPosition1 = new ElementPosition("px", 10, 10, 5);
  const elementPosition2 = new ElementPosition("px", 10, 10, 4);
...
test("is comparable with other element positions with precision", function() {
  const elementPosition1 = new ElementPosition("px", 10.005, 10.005, 5.005);
  const elementPosition2 = new ElementPosition("px", 10.01, 10.01, 5.01);
...
test("can be offsetted by other element position and stays immutable", function() {
  const elementPosition = new ElementPosition("px", 1, 2, 4);
  const offsetted = elementPosition.offset(new ElementPosition("px", 8, 16, 32));
