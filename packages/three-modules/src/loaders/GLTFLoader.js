...
import { radToDeg } from "@personalidol/math/src/radToDeg";

export class GLTFLoader extends Loader {
  constructor(manager, textureLoader) {
    super(manager);
  ...
  parse(data, path, onLoad, onError) {
    ...
    const parser = new GLTFParser(this.textureLoader, json, {
...
class GLTFParser {
  constructor(textureLoader, json = {}, options = {}) {
    this.json = json;
    this.extensions = {};
    this.plugins = {};
