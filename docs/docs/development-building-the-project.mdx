---
id: development-building-the-project
title: Building the project
description: How to build and maintain the Personal Idol project.
slug: /development/building-the-project
---
...
You can technically build this project with `npm` and link dependencies
yourself, but it will result in much bigger build size (`npm` does not support
...
```nginx title="/etc/nginx/sites-available/personalidol.conf"
server {
